...
const OmniSocialSharingEcosystem = () => {
  useEffect(() => {
...
<button className="w-full text-left px-md py-sm bg-surface-container-low rounded-full text-on-surface-variant font-label-md hover:bg-surface-container-high transition-colors">
...
{/*  Feed (Active)  */}
<a className="flex flex-col items-center justify-center bg-primary-container text-on-primary-container rounded-xl px-3 py-1 active:scale-90 transition-transform" href="#">
...
{/*  Share  */}
<a className="flex flex-col items-center justify-center text-on-surface-variant px-3 py-1 hover:bg-surface-variant transition-colors active:scale-90 transition-transform" href="#">
...
export default OmniSocialSharingEcosystem;
