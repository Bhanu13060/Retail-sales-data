...
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-tertiary text-sm">photo_library</span>
<h2 className="font-label-md text-on-surface uppercase tracking-widest text-[10px]">Shared Media</h2>
</div>
...
<div className="flex-shrink-0 w-24 h-24 rounded-lg overflow-hidden group cursor-pointer relative">
<img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="A futuristic UI dashboard design showing holographic data charts, vibrant electric purple and cyan gradients, glassmorphism textures, high-quality 3D render for a tech presentation." src="https://lh3.googleusercontent.com/aida-public/AB6AXuB3an0EkSDeA9dRVuR_muGuVaPSVhqkPIbuYjdGKyRWVisCzd6w2MKaQsc7f4DjmlsEiTiVXAJf46d8ewb_hMtD5nCCO9Sy4qGGu0gkH4vUc711weiO9_0DIjG33NxrVcT9sKbuBsEQaAN6VFEHzP9IIXrtQHFRXdjiYdWs5CFelSlLXu3j5bF34t78D16HgnqTFQ6ybxn6rlaTSoCeNKVPbCid59r10RReLw8f9m9VMxXwHSamF5HJ6A"/>
<div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors"></div>
</div>
<div className="flex-shrink-0 w-24 h-24 rounded-lg overflow-hidden group cursor-pointer relative">
<img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="A breathtaking night cityscape with neon architecture, deep indigo skies, and reflections on a glass skyscraper, cinematic lighting, ultra-modern urban photography matching the Lumina aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDo8gBPARx0SXE7Tm8xu8qYs-h_hk9XzYuLDMEXC-2c99QYZ_Kin_mQwgfjZ1ziaD6SGLzIHO3Bh3jQuqc_VnZQfzNpehwpuTNfDZ4msV64x72loZIe4nRlqJjpitJl9V20cbKgk2HnjC_wnqZJ7ksAMHV6NEyG0qeq2aP2C4c4medYOXjRFahFpVCCVncm6oG6S3oAz96oDyqz5XHny4YEmH266TbD9YmHrJEtspdLhJRRP0mTIdn6aQ"/>
<div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors"></div>
</div>
<div className="flex-shrink-0 w-24 h-24 rounded-lg overflow-hidden group cursor-pointer relative">
<img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="Abstract 3D glass shapes with light refraction, iridescent colors, dark background, premium tech wallpaper style, high-resolution octane render, sophisticated visual identity." src="https://lh3.googleusercontent.com/aida-public/AB6AXuD0s6i8n4KLtoHmLuy8K-aO4b5uXeOV72lfeAYq4cfiP7OzyFlHWlMmbBzUOItl0KjyTYSLBIJMCqR_vlCOyrALFxe3y2BwxNi5-75ZtbVh9CjYkEmuXA3TN1XSF3QZyn9UdeEp_a1j_rL884nHywPZJrrN-nYcnhzCL_MizOuoAJbCjA5LzJE1eSjzKrP3Xc2MC30Ae8cbIo2uYoMSljcnEB9TWeCafw2UueV4jcMeI9l3hj65z152NQ"/>
<div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors"></div>
</div>
<div className="flex-shrink-0 w-24 h-24 rounded-lg overflow-hidden group cursor-pointer relative">
<img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="A clean, minimalist workspace with a curved monitor displaying code, dark room, ambient purple LED lighting, professional photography, high-end developer environment." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDrd58S7A3TXSivac8jPWL50foOU1GTmes2LP1mV1lfB4R8M9FEkQDpOgOTMdbMVGIytuqpukIwopVWhPbFnCWpIvzYtq5IF1ksMoHxvbSpeRpBD6WSJHKvTpaRnX5EOsUL9L0LflTDmcHrAblJeFr0_gSzHqKVtUO4pIz4vSfwd4MqCQQ6bta8AftEa528W-GqxshgvboB7jeiUaXZzFLb8Js-KQ4VyuZvE_A1oUNEdObh_d_GfHSFZQ"/>
<div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors"></div>
</div>
</div>
</div>
...
export default OmniGroupChatpremium;
